        ...
        <img src="http://ssl.gstatic.com/accounts/ui/avatar_2x.png" alt="" class="img-rounded img-responsive" />
                    ...
                    <div class="col-sm-6 col-md-8">
                        ...
                        <p>
                            ...
                            <br />
                            <b>Persno:</b> {{ $staff_basic->persno }}
                            <br />
                            <b>Company:</b> {{ $staff_basic->company_id}} {{ $staff_basic->companyid->company_descr }}
                            <br />
                            ...
                            <!-- <b>Lob:</b> amik mana
                            <br /> -->
                            <b>Region:</b> {{ $staff_basic->getreg()->region }}
                            <br />
                            <b>Emp Status:</b> {{ $staff_basic->emptstat ?? 'N/A'}}
                            <br />
                            <b>Salary (RM):</b> {{ $gaji->salary ??'N/A' }}
                            <br />
                            <b>Allowance (RM):</b> {{ $OtIndicator->allowance ??'N/A' }}
                            <br />
                            <b>Work Schedule:</b> {{ $skedul->shiftpattern->code ??'' }} {{$skedul->shiftpattern->description ?? ''}}
                            @if( $defaultWS == '')
                            @else
                            {{$defaultWS}}
                            @endif
                            <br />
                            <!-- <b>Last updated : </b>
                            @if( $staff_detail->upd_sap == '')
                            N/A
                            @else
                            {{ date('d-m-Y', strtotime($staff_detail->upd_sap)) }}
                            @endif
                            <br /> -->
                            <!-- <b>Allowance:</b>
                            <br /> -->
        ...
        <div class="col-sm-6 col-md-4">
                    ...
                    <div class="col-sm-6 col-md-8">
                        <h4>{{ $staff_basic->companyid->company_descr}}</h4>
                            <p>
                            <b>Personal Area:</b> {{ $staff_psubarea->perssubarea }} {{ $staff_psubarea->perssubareades }}
                            <br />
                            <b>Personal Subarea:</b> {{ $staff_psubarea->persarea }} {{ $staff_psubarea->persareadesc }}
                            <br />
                            <b>Cost Center:</b> {{ $staff_detail->costcentr }}
                            <br />
                            <br />
...
<div class="form-group text-center">
  <br>
  <form action="{{ route('staff.list', [], false) }}" method="post">
      @csrf
