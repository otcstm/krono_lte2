...
<div class="row row-eq-height">
  ...
  <div class="col-md-3 col-sm-6 col-xs-12 ">
    ...
    <h3 class="box-title text-left">Manage User Role</h3>
    </div><!-- /.box-header -->
    </div>
    </a>
  </div>
  ...
  <div class="col-md-3 col-sm-6 col-xs-12 ">
    ...
    <div class="box-header text-center bg-yellow-active color-palette">
    <h3 class="box-title text-left">Manage User Company</h3>
    </div><!-- /.box-header -->
    </div>
    </a>
  </div>
  ...
  <div class="col-md-3 col-sm-6 col-xs-12 ">
    ...
    <div class="box-header text-center bg-yellow-active color-palette">
    <h3 class="box-title text-left">Manage State</h3>
    </div><!-- /.box-header -->
    </div>
    </a>
  </div>
  ...
  <div class="col-md-3 col-sm-6 col-xs-12 ">
    ...
    <div class="box-header text-center bg-yellow-active color-palette">
    <h3 class="box-title text-left">Manage Subarea for State</h3>
    </div><!-- /.box-header -->
    </div>
    </a>
  </div>
...
<div class="row row-eq-height">
 ...
 <!-- /t2 --> 
  ...
  <div class="col-md-3 col-sm-6 col-xs-12 ">
    ...
    <div class="box-header text-center bg-yellow-active color-palette">
    <h3 class="box-title text-left">System Eligibility</h3>
    </div><!-- /.box-header -->
    </div>
    </a>
  </div> 
 ...
 <!-- /t1 -->
  ...
  <div class="col-md-3 col-sm-6 col-xs-12 ">
    <a href="{{ route('ot.admin', [], false) }}">
      ...
      <div class="box-header text-center bg-yellow-active color-palette">
      <h3 class="box-title text-left">Claim Manual Approval</h3>
      </div><!-- /.box-header -->
      </div>
      </a>
    </div>
